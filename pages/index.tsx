...
import { Grid, Container, SimpleGrid, Paper, Title, Text } from '@mantine/core';
...
export default function Home() {
  ...
  return (
    <>
      <Container my="md">
        <SimpleGrid cols={2} spacing="md" breakpoints={[{ cols: 1 }]}>
          <Grid>
            <Grid.Col xs={12}>
            ...
            {/*<Grid.Col xs={7}>
               <Paper shadow="xl" p="xl" withBorder> 
                <Title order={2} align='center'>FAQs</Title>
                <br></br>
